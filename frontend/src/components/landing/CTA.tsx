...
export default function CTA() {
  return (
    <section className="relative overflow-hidden py-20 lg:py-28 border-t border-slate-200 bg-white dark:border-slate-900 dark:bg-slate-950 transition-colors">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
        <div className="relative rounded-3xl border border-slate-200 bg-slate-50/80 dark:border-slate-800 dark:bg-slate-900/40 px-6 py-12 shadow-2xl backdrop-blur-md sm:px-12 sm:py-20 overflow-hidden">
          ...
          <div className="relative flex flex-col items-center max-w-2xl mx-auto">
            {/* Action Badge */}
            <div className="inline-flex items-center gap-1.5 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-3 py-1 text-xs font-semibold text-indigo-600 dark:bg-indigo-500/5 dark:text-indigo-400 backdrop-blur-sm mb-6">
