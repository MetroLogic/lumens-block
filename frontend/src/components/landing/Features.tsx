  ...
  const features = [
    {
      ...
      icon: Layers,
      color: "text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-500/20 bg-blue-50/50 dark:bg-blue-500/5 hover:border-blue-300 dark:hover:border-blue-500/40",
    ...
    },
    {
      ...
      icon: Zap,
      color: "text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-500/20 bg-amber-50/50 dark:bg-amber-500/5 hover:border-amber-300 dark:hover:border-amber-500/40",
    ...
    },
    {
      ...
      icon: LayoutGrid,
      color: "text-purple-600 dark:text-purple-400 border-purple-200 dark:border-purple-500/20 bg-purple-50/50 dark:bg-purple-500/5 hover:border-purple-300 dark:hover:border-purple-500/40",
    ...
    },
    {
      ...
      icon: Award,
      color: "text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-500/20 bg-emerald-50/50 dark:bg-emerald-500/5 hover:border-emerald-300 dark:hover:border-emerald-500/40",
      bullets: ["Low barrier of entry", "Instant visual response", "Designed for designers & PMs"]
    }
  ]

  return (
    <section id="features" className="relative border-t border-slate-200 bg-white dark:border-slate-900 dark:bg-slate-950 py-20 lg:py-28 transition-colors">
              ...
              >
                <div>
                  <div className="flex items-center gap-3.5 mb-5">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                ...
                {/* Bullets */}
                <ul className="mt-8 space-y-2.5 border-t border-slate-200 dark:border-slate-900 pt-6">
                  {feature.bullets.map((bullet, bulletIdx) => (
                    <li key={bulletIdx} className="flex items-center gap-2 text-xs text-slate-700 dark:text-slate-300">
